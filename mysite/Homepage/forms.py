...
class UserForm(forms.ModelForm):
    first_name = forms.CharField(validators=[validators.MinLengthValidator(3, "Name must be at least 4 characters long.")], widget=forms.TextInput(attrs={'placeholder': 'Name', 'style': 'width: 200px;'}))
